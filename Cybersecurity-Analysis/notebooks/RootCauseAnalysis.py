...
#define filepath ===========
# === Define File Paths ===
input_file_path = r"synthetic_cybersecurity_bank_data.csv"    #input instead of X your user profile, your ID
output_file_path = r"Root_Cause_Analysis_Output.csv"         #input instead of X your user profile, your ID
