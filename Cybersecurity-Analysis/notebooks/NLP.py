...
file_path = r"synthetic_cybersecurity_bank_data.csv"    #input instead of X your user profile, your ID
...
bigram_df = pl.DataFrame({
    "words": [bigram for bigram, count in sorted_bigrams],
    "amount": [count for bigram, count in sorted_bigrams]
})
