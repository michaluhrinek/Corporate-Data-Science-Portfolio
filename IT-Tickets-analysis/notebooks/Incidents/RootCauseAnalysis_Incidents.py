#Root Cause Analysis - Incidents
#import libraries 
import os
import polars as pl 
#define filepath ===========
# === Define File Paths ===
input_file_path = r"C:\Users\X\Downloads\synthetic_incident_bank_data_weighted.csv"   #change X for your username
output_file_path = r"C:\Users\X\Downloads\Root_Cause_Analysis_Incidents_data.csv"    #change X for your username
...
## KPI Breach Analysis by Priority
...
## RCA by Reopen Count in Assignment Group
