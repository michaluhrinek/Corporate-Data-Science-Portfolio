#Exploratory Data Analysis - Incidents Dataset (EIDA)
...
output_file_path = r"C:\Users\X\Downloads\EIDA_incidents_data.csv"  #change X for your username
...
if "KPI_breach" not in df.columns and all(col in df.columns for col in ["Priority", "Processing Time Hours"]):
    df = df.with_columns(
        (
            ...
            .when((pl.col("Priority") == "High") & (pl.col("Processing Time Hours") > 16)).then(1)
