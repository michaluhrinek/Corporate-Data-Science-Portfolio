...
# Define file paths
input_file_path = r"synthetic_problem_bank_data_weighted.csv"
output_file_path = r"C:\Users\X\Downloads\EIDA_problems_data.csv"  #change X for your username
...
# KPI_breach: Based on Priority and Processing Time Hours
